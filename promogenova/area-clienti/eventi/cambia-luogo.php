...
// cambia quartiere
if (isset($_POST['ev_idM']) && $_POST['ev_idQ']!=$ev_idQ) {
    $ev_idQ=$_POST['ev_idQ'];
    $salva="s";
}
// cambia municipio
if (isset($_POST['ev_idM']) && $_POST['ev_idM']!=$ev_idM) {
    $ev_idM=$_POST['ev_idM'];
    $salva="s";
}
// cambia comune
if (isset($_POST['ev_idC']) && $_POST['ev_idC']!=$ev_idC) {
    $ev_idC=$_POST['ev_idC'];
    $salva="s";
}
// cambia provincia
if (isset($_POST['ev_idP']) && $_POST['ev_idP']!=$ev_idP) {
    $ev_idP=$_POST['ev_idP'];
    $salva="s";
}
// cambia regione
if (isset($_POST['ev_idR']) && $_POST['ev_idR']!=$ev_idR) {
    $ev_idR=$_POST['ev_idR'];
    $salva="s";
}
...
if ($salva=="s") {
    ...
    if($ev_idQ>0){$ev_luogo.=" ".$quartieri['quartiere'][$ev_idQ];} else{$ev_luogo.=" ";}
      ...
      $_SESSION['ev_idQ']=$ev_idQ; 
            ...
            idR='".mysqli_real_escape_string($conn,stripslashes($ev_idR))."',  
            idP='".mysqli_real_escape_string($conn,stripslashes($ev_idP))."',  
            idC='".mysqli_real_escape_string($conn,stripslashes($ev_idC))."',  
            idM='".mysqli_real_escape_string($conn,stripslashes($ev_idM))."',  
            idQ='".mysqli_real_escape_string($conn,stripslashes($ev_idQ))."'  
            WHERE id='".$id."'";
...
// struttura html
$title="Admin ".$attivita." - Evento ".$id." - Modifica luogo";
$metaDescription="";
$metaKeywords="";
$metaRobots="NONE";
...
<h3 class="rosso">Modifica il luogo dell'evento n.ro <?php print $id; ?></h3><br />
<br />
...
?>    
<p><a href="cambia-luogo.php?rip=s&amp;id=<?php print $id;?>">Clicca qui</a> se vuoi ripartire dalla zona in cui opera la tua Attivit&agrave;<br /><br /></p>
