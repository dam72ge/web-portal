...
// struttura html
$title="Vetrine web ".$dove;
$metaDescription="Vetrine web di Attivit&agrave; presenti in ".$dove;
$metaKeywords="vetrine web, vetrine ".strtolower($dove).", vetrine ".strtolower($zona).", promogenova";
$metaRobots="ALL";
...
<div class="colonna-1">
<a name="vetrine"></a>
<h2 class="bianco sfTondo sfVerde">Vetrine web <?php print $dove; ?></h2>
<p><br />
<?php
// vetrine
$where=str_replace("AND","",$where);
if ($zona=="regione") { $where=str_replace("WHERE","",$where); }
$orderby="attivita ASC, idAttivita DESC";
$quanteVisualizzare=1500;
$mysql->vetrine_per_zona($where,$orderby,$url,$dove,$quanteVisualizzare);
?>
</p><br /><br />
</div>
</div>
